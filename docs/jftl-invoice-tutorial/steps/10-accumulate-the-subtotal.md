...
Runnable file: [`10-accumulate-the-subtotal.template.json`](10-accumulate-the-subtotal.template.json)
...
Expected output: [`10-accumulate-the-subtotal.output.json`](10-accumulate-the-subtotal.output.json)
...
← [Calculate line amount and weight](09-calculate-line-amount-and-weight.md) | [Tutorial index](../README.md) | [Accumulate total weight](11-accumulate-total-weight.md) →
